...
- 2f3406f：放大专家推荐文字
- 9910db1：修复专家推荐重叠并补充未来方向
- 91da708：优化选科问答与卡片布局
- cc5e62c：优化选科说明与专家推荐
- 0692e28：实现选科界面并接入Home
- c71cb58：打通学期结束回Home与放假入口
- 2f510f8：Home加入继续主线并补充开发记录
- 7c0b518：实现主界面Home
- 24054b2：忽略本地心跳文件
...
- 继续打磨 Subject（选科）的体验
  - 专家问答：补更生活化的“为什么推荐”说明（更像老师/专家口吻），并把选项文案再精炼
  - 规则差异：后续如果要按省份规则限制专业/科目可选范围，需要把规则表接入（当前为通用版）
