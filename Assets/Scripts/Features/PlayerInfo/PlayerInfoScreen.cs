        ...
        public override void Refresh()
        {
            ...
            if (avatarImage != null)
            {
                ...
                if (sprite != null)
                {
                    ...
                    avatarImage.rectTransform.anchorMin = new Vector2(avatarImage.rectTransform.anchorMin.x, 0.5f);
                    avatarImage.rectTransform.anchorMax = new Vector2(avatarImage.rectTransform.anchorMax.x, 1f);
                    avatarImage.rectTransform.pivot = new Vector2(avatarImage.rectTransform.pivot.x, 1f);
                }
                else
                {
